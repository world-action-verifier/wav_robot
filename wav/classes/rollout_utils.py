...
from wav.dreamer.tools import add_to_cache, save_episodes as save_episodes_to_disk
...
def collect_onpolicy_trajs(
    ...
    if save_dir is not None and save_episodes_to_file:
        print("Saving Episodes to Disk: ", eps_names, " at ", save_dir)
        save_episodes_to_disk(
