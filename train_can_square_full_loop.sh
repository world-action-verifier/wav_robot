...
# WM-only full loop for can + square (default).
# Example:
#   bash train_can_square_full_loop.sh
#   CUDA_VISIBLE_DEVICES=0 TASKS="can square" SAMPLE_SELECTION_STRATEGY=random bash train_can_square_full_loop.sh
