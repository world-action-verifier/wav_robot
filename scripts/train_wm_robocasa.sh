...
# Environment preset for robocasa WM-only training.
# All hyperparameters stay fully controllable via env vars.

SUITE="${SUITE:-robocasa}"
TASKS="${TASKS:-stack door bread cereal nutassemblyround breadcanfixed breadcanrandom}"
METHOD="${METHOD:-random}"
EXP_NAME="${EXP_NAME:-dp_collect_diverse_stack_demos50_n30_noise0.10}"
