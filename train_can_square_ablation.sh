...
# WM-only ablation for can + square (no sample mixing).
# Example:
#   bash train_can_square_ablation.sh
...
for TASK in ${TASKS}; do
  ...
  RUN_NAME="wm_only_${TASK}_ablation_mix0_${SAMPLE_SELECTION_STRATEGY}_n${SAMPLE_SELECT_SIZE}_start${SAMPLE_START_ITR}"
