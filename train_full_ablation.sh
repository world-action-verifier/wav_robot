...
# Baseline ablation: no sample mixing.
...
python3 train_sailor.py \
  ...
  --wandb_exp_name "wm_only_${TASK}_ablation_mix0_${SAMPLE_SELECTION_STRATEGY}_n${SAMPLE_SELECT_SIZE}_start${SAMPLE_START_ITR}" \
